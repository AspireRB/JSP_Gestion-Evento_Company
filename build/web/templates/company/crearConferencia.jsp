            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h1 class="mb-0">Crear conferencia</h6>
                    </div>
                    <div class="row g-4">
                            ...
                            <div class="bg-light rounded h-100 p-4" >                                                                   
                                <div class="form-floating mb-3">
                                    <select class="form-select" id="floatingSelect"
                                        ...
                                        <option value="1">Feria del libro</option>
                                        <option value="2">Feria de las dos ruedas</option>
                                        <option value="3">Feria de agricultura</option>
                                    </select>
                                ...
                                <div class="bg-light rounded h-100 p-4">
                                    <div class="m-n2">
                                        <a class="btn btn-lg btn-primary w-100" href="Conferencias.jsp">Crear</a>
                                    </div>
                                </div>
                            </div>
                        </div>                        
